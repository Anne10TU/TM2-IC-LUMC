...
def show_occlusie_choice(scenario):
    ...
    def handle_choice(choice):
        popup.destroy()
        # Stuur het eerste commando voor occlusie naar de Arduino
        send_command(scenario)  # Eerst de occlusie versturen
        # Voeg een vertraging in om te wachten op verwerking van het eerste commando
        time.sleep(0.5)  # Vertraging van 0,5 seconde
        # Stuur het tweede commando voor "mild" of "ernstig"
        send_command(choice)    # Dan de keuze voor mild/ernstig versturen
