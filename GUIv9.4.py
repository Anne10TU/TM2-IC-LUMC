...
arterial_slider_frame = tk.Frame(slider_frame)
arterial_slider_frame.pack()

tk.Label(arterial_slider_frame, text="55%", font=("Arial", 12)).pack(side="left")
arterial_slider = tk.Scale(arterial_slider_frame, from_=55, to_=95, orient="horizontal", variable=arterial_dc,
                           command=update_dc_values)
arterial_slider.pack(side="left")
tk.Label(arterial_slider_frame, text="95%", font=("Arial", 12)).pack(side="left")

# Veneuze schuifregelaar en labels
tk.Label(slider_frame, text="Veneuze Duty Cycle:", font=("Arial", 14)).pack(pady=(20, 5))

venous_slider_frame = tk.Frame(slider_frame)
venous_slider_frame.pack()

tk.Label(venous_slider_frame, text="55%", font=("Arial", 12)).pack(side="left")
venous_slider = tk.Scale(venous_slider_frame, from_=55, to_=95, orient="horizontal", variable=venous_dc,
                         command=update_dc_values)
venous_slider.pack(side="left")
tk.Label(venous_slider_frame, text="95%", font=("Arial", 12)).pack(side="left")
